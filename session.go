...
func (s *Session) InitializeHTTP(req *http.Request) {
    ...
    BroadcastNotifier("/stream", SessionUpdated, s.ToApiSession())
}
...
func deactivateSession(session *Session) {
    ...
    BroadcastNotifier("/stream", SessionUpdated, session.ToApiSession())
...
func createSession(ip string) (*Session, error) {
    ...
    BroadcastNotifier("/stream", SessionCreated, session.ToApiSession())
...
func PurgeSession(s *Session) {
    ...
    BroadcastNotifier("/stream", SessionDeleted, s.Key)
}
